  ...
  const createListing = async (status?: string) => {
    ...
    try {
      ...
      toast.success(status === "draft" ? "Draft saved" : "Listing published", {
        description: status === "draft" ? "Your listing is saved as a draft." : "Your listing is now live.",
      });
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={() => createListing("draft")} disabled={publishing} className="gap-2">

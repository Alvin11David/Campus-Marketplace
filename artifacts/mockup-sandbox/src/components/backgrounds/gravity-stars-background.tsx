...
export function GravityStarsBackground({
    ...
    for (let i = 0; i < starsRef.current.length; i++) {
      ...
      if (dist < mouseInfluence && dist > 0) {
        ...
        if (glowAnimation === "instant") {
          ...
          const springVal = (targetGlow - currentGlow) * 0.2;
          const damping = 0.85;
          p.glowVelocity = (p.glowVelocity || 0) * damping + springVal;
        ...
        if (glowAnimation === "instant") {
          ...
          const springVal = (targetGlow - currentGlow) * 0.15;
          const damping = 0.9;
          p.glowVelocity = (p.glowVelocity || 0) * damping + springVal;
  ...
  return (
    <div
      ...
      className={cn(
        "relative size-full overflow-hidden text-foreground dark:text-white",
        className,
      )}
